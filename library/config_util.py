...
def generate_inpaint_dataset_group_by_blueprint(dataset_group_blueprint: DatasetGroupBlueprint):
  datasets: List[Union[DreamBoothInpaintDataset, FineTuningDataset]] = []

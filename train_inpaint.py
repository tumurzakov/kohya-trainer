...
def train(args):
    ...
    train_dataset_group = config_util.generate_inpaint_dataset_group_by_blueprint(blueprint.dataset_group)
    ...
    for epoch in range(num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(network):
                ...
                masks = masks.reshape(-1, 1, mask.shape[2] // 8, mask.shape[3] // 8)
